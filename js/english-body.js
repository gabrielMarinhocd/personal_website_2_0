          ...
          <div class="row ">
              ...
              <div class="menu desktop-menu">
                ...
                <div class="link-menu">
                  <ul>
                    ...
                    <li  onclick="modalCurriculum()"><a href="#" rel="noopener noreferrer">Curriculum  <i id="icon-download" class="fas fa-download"></i></a></li> 
            ...
            <div class="col-8 center  conteudo ">
              ...
              <div id="education" class=" container education">
                ...
                <div class="box">
                  <div class="box-title">
                    <h4>   Studying MBA - Multiplatform Mobile Developer IGTI <span id="ed-04" class="rigth ed"><i  class="fas fa-chevron-down"></i></span></h4>
                  </div>
                ...
                <div class="box">
                  ...
                  <div class="box-content iten-05">
                    ...
                    <br/>
                    <span class="sub-title">Full Stack Javascript Developer - IGTI</span>
                  </div>
                </div>
                  ...
                  <div class="row ">
                    ...
                    <div id="feedback" class="container col-6 blue">
                      ...
                      <form onsubmit="feedback()" id="form">
                        ...
                        <div>
                          <textarea  id="message" rows="3" placeholder="Leave your mensage" required></textarea>
                        </div>
                    ...
                    <div class="col-12 center copyrigth-content ">
                        <span class="copyrigth"> <i class="far fa-copyright"></i>  Copyrigth 2022 all rights reserved</span>
                        <br/>
              ...
              <div class="menu">
                ...
                <div class="link-menu">
                  <ul>
                    ...
                    <li><a href="#work"  rel="noopener noreferrer">Works</a></li> 
                    <li> <a href="#gallery" rel="noopener noreferrer">Gallery</a> </li>
                    <li  onclick="modalCurriculum()" data-bs-dismiss="modal" aria-label="Close" ><a href="#"  rel="noopener noreferrer">Curriculum <i id="icon-download" class="fas fa-download"></i></a></li> 
                    <li><a href="#contact"  rel="noopener noreferrer">Contact</a></li> 
                  </ul>
                </div>
